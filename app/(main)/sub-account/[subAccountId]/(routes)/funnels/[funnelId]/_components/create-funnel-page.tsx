...
export const CreateFunnelPage: React.FC<CreateFunnelPageProps> = ({
    defaultData,
    funnelId,
    order,
    subAccountId,
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2">
                            <Button
                                ...
                                type="submit"
                            >
                                {form.formState.isSubmitting ? <Loader2 className="animate-spin h-4 w-4" /> : "Save Page"}
                            </Button>
                            {defaultData?.id && (
                                <Button
                                    variant={"outline"}
                                ...
                                >
                                  {form.formState.isSubmitting ? <Loader2 className="animate-spin h-4 w-4" /> : <Trash />}
                                </Button>
                            )}
                            {defaultData?.id && (
                                <Button
                                ...
                                >
                                    {form.formState.isSubmitting ? <Loader2 className="animate-spin h-4 w-4" /> : <CopyPlusIcon />}
                                </Button>
                            )}
                        </div>
                    </form>
